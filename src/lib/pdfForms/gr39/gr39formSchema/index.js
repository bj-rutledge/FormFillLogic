 ...
 *  * There are several somewhat complicated interdependencies in the forms.
 * This schema defines all of the required and interdependent fields. 
 * For example, if fild 'x' is populated, then field 'y' and 'z' must be 
 * poplulated but not field 'a', etc.
...
const keys = {
  ...
  p_notWillful2: Joi.string().description(
    'If p_notWillful.length > 100, we divide the text between these two props.'
  ),
